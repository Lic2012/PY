...
if __name__ == '__main__':
    ...
    for item in test:
        ...
        for i in range(len(wordList)):
            if '('+item[1]+')' in wordList[i]: 
            #FIND ACRONYM FORMMAT: (ACRO)
                sit1_cnt += 1 #COUNT FOR (ACRO) FORMAT
                ...
                l = i - 1
                l_secure = i - 1
                while(len(first_char) > 0 and i-l<2*(len(item[1]))):
                    ...
                    while (m>=0):
                        try: 
                            ...
                            print "EREREERERERERERRRRRRRRRRRRRRRRR: "
                            print wordList
                            print "wordList: ",wordList[l]
                            print first_char
                            print "l: ",l
                        m -= 1
                ...
                if outprint != '':
                    ...
                    while(n>=0):
                        if outprintList[n] in stp:
                            del outprintList[n]
                        n-=1
                    if len(outprintList) < len(item[1]):
                        print "***********************************************"
    ...
    print sit1_cnt
                ...
                #print i
                #find The/the, write down location j
#                 j = i-1
#                 while(j > 0):
#                     if wordList[j].startswith('T') or wordList[j].startswith('t'):
#                         ##print j
#                         break
#                     j-=1
#                 #print item[1],':', # des acronym
#                 # query expand situation 1
#                 if i-j<=2*(len(item[1])):
#                     for k in range(j+1,i):
#                         print wordList[k],' ',
#                     print
#                 # find the longest expand char
#                 else:
