...
def finder(searchlist):
    indexf = open("C:\\Users\\Administrator\\Desktop\\candidate_0728.info")
    item = searchlist[2]
    qid = searchlist[0]
    qname = searchlist[1]
    canlist = []
...
searchlist = qeBracket.returnsearchlist(test)

data = [i for i in searchlist]

pool = threadpool.ThreadPool(10)

requests = threadpool.makeRequests(finder, data, print_result)
